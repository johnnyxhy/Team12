...
void VPCsrc___024root__trace_chg_sub_0(VPCsrc___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VPCsrc___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPCsrc___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VPCsrc___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VPCsrc___024root__trace_chg_sub_0(VPCsrc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VPCsrc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPCsrc___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    bufp->chgIData(oldp+0,(vlSelf->branch_PC),32);
    bufp->chgIData(oldp+1,(vlSelf->inc_PC),32);
...
void VPCsrc___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPCsrc___024root__trace_cleanup\n"); );
    // Init
    VPCsrc___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VPCsrc___024root*>(voidSelf);
    VPCsrc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
