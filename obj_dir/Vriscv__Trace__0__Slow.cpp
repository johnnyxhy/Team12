...
VL_ATTR_COLD void Vriscv___024root__trace_init_sub__TOP__0(Vriscv___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+83,"rst", false,-1);
    tracep->declBus(c+84,"a0", false,-1, 31,0);
    ...
    tracep->declBus(c+86,"branch_pc", false,-1, 31,0);
    tracep->declBus(c+87,"inc_pc", false,-1, 31,0);
    ...
    tracep->declBus(c+39,"ImmSrc", false,-1, 11,0);
    ...
    tracep->declBus(c+85,"IN_WIDTH", false,-1, 31,0);
    tracep->declBit(c+46,"eq", false,-1);
    tracep->declBus(c+35,"instr", false,-1, 31,0);
    tracep->declBit(c+36,"RegWrite", false,-1);
    tracep->declBus(c+37,"ALUctrl", false,-1, 2,0);
    ...
    tracep->declBus(c+85,"RAMZ", false,-1, 31,0);
    ...
    tracep->declBus(c+85,"Data_width", false,-1, 31,0);
    tracep->declBus(c+44,"d0", false,-1, 31,0);
    ...
    tracep->declBus(c+49,"ad3", false,-1, 4,0);
    tracep->declBit(c+36,"we3", false,-1);
    tracep->declBus(c+45,"wd3", false,-1, 31,0);
    tracep->declBus(c+42,"rd1", false,-1, 31,0);
    tracep->declBus(c+44,"rd2", false,-1, 31,0);
    tracep->declBus(c+84,"a0", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+50+i*1,"register_array", true,(i+0), 31,0);
    }
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vriscv___024root__trace_full_sub_0(Vriscv___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+39,(vlSelf->riscv__DOT__ImmSrc),12);
    bufp->fullBit(oldp+40,(vlSelf->riscv__DOT__PCsrc));
    bufp->fullIData(oldp+41,((((- (IData)((1U & ((IData)(vlSelf->riscv__DOT__ImmSrc) 
                                                 >> 0xbU)))) 
                               << 0xcU) | (IData)(vlSelf->riscv__DOT__ImmSrc))),32);
    bufp->fullIData(oldp+42,(vlSelf->riscv__DOT__aluop1),32);
    bufp->fullIData(oldp+43,(vlSelf->riscv__DOT__aluop2),32);
    bufp->fullIData(oldp+44,(vlSelf->riscv__DOT__my_regfile__DOT__register_array
                             [(0x1fU & (vlSelf->riscv__DOT__instr 
                                        >> 0x14U))]),32);
    bufp->fullIData(oldp+45,(vlSelf->riscv__DOT__aluout),32);
    bufp->fullBit(oldp+46,(vlSelf->riscv__DOT__eq));
    bufp->fullCData(oldp+47,((0x1fU & (vlSelf->riscv__DOT__instr 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+48,((0x1fU & (vlSelf->riscv__DOT__instr 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+49,((0x1fU & (vlSelf->riscv__DOT__instr 
                                       >> 7U))),5);
    bufp->fullIData(oldp+50,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[0]),32);
    bufp->fullIData(oldp+51,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[1]),32);
    bufp->fullIData(oldp+52,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[2]),32);
    bufp->fullIData(oldp+53,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[3]),32);
    bufp->fullIData(oldp+54,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[4]),32);
    bufp->fullIData(oldp+55,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[5]),32);
    bufp->fullIData(oldp+56,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[6]),32);
    bufp->fullIData(oldp+57,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[7]),32);
    bufp->fullIData(oldp+58,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[8]),32);
    bufp->fullIData(oldp+59,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[9]),32);
    bufp->fullIData(oldp+60,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[10]),32);
    bufp->fullIData(oldp+61,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[11]),32);
    bufp->fullIData(oldp+62,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[12]),32);
    bufp->fullIData(oldp+63,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[13]),32);
    bufp->fullIData(oldp+64,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[14]),32);
    bufp->fullIData(oldp+65,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[15]),32);
    bufp->fullIData(oldp+66,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[16]),32);
    bufp->fullIData(oldp+67,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[17]),32);
    bufp->fullIData(oldp+68,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[18]),32);
    bufp->fullIData(oldp+69,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[19]),32);
    bufp->fullIData(oldp+70,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[20]),32);
    bufp->fullIData(oldp+71,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[21]),32);
    bufp->fullIData(oldp+72,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[22]),32);
    bufp->fullIData(oldp+73,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[23]),32);
    bufp->fullIData(oldp+74,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[24]),32);
    bufp->fullIData(oldp+75,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[25]),32);
    bufp->fullIData(oldp+76,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[26]),32);
    bufp->fullIData(oldp+77,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[27]),32);
    bufp->fullIData(oldp+78,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[28]),32);
    bufp->fullIData(oldp+79,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[29]),32);
    bufp->fullIData(oldp+80,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[30]),32);
    bufp->fullIData(oldp+81,(vlSelf->riscv__DOT__my_regfile__DOT__register_array[31]),32);
    bufp->fullBit(oldp+82,(vlSelf->clk));
    bufp->fullBit(oldp+83,(vlSelf->rst));
    bufp->fullIData(oldp+84,(vlSelf->a0),32);
    bufp->fullIData(oldp+85,(0x20U),32);
    bufp->fullIData(oldp+86,(vlSelf->riscv__DOT__branch_pc),32);
    bufp->fullIData(oldp+87,(vlSelf->riscv__DOT__inc_pc),32);
